            ...
            <form method="POST" action="{{ route('dashboard.utilisateur.store') }}" class="space-y-6">
                ...
                <div class="field-section">
                    <h3 class="field-section-title">
                        <i class="fas fa-user-tag mr-3 text-indigo-600"></i>
                        Sélection du Rôle
                    </h3>
                    <div class="relative">
                        <label for="role_id" class="label-custom">
                            <i class="fas fa-user-cog mr-2 text-indigo-500"></i>
                            Rôle de l'utilisateur
                        </label>
                        <select name="role_id" id="role_id" required class="form-select-custom appearance-none">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Déclencher l'événement au chargement de la page pour les valeurs préremplies
        if (roleSelect.value) {
