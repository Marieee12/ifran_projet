    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Analyse des données de présence et cours</p>
            </div>
...
<div class="bg-gray-50 min-h-screen">
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Classement par ordre décroissant avec code couleur</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-xl font-bold text-gray-900">Taux de Présence par Classe</h2>
                    <p class="text-sm text-gray-600">Comparaison des performances par classe</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-xl font-bold text-gray-900">Volume de Cours Dispensés</h2>
                    <p class="text-sm text-gray-600">Répartition par type de cours (Présentiel, E-learning, Workshop)</p>
                </div>
                <div class="flex space-x-4 text-sm">
                    <div class="flex items-center">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Résumé des Statistiques</h2>
...
function exportCharts() {
    // Créer un PDF avec les graphiques
