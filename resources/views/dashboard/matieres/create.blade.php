...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-md p-6 mt-8">
    ...
    <form method="POST" action="{{ route('matieres.store') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nom_matiere" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Code de la matière</label>
            <input type="text" name="code_matiere" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
